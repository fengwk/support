 ...
 * @author fengwk
 */
public class ExtensionConventionMapperImpl<E extends BasicEntity<I>, P extends BasicPO<I>, I> implements ExtensionConventionMapper<E, P, I> {

    final ConventionMapper<E, P, I> conventionMapper;
    final Class<P> poClass;
    final PropertyMapper<E, P> propertyMapper;
    
    ExtensionConventionMapperImpl(ConventionMapper<E, P, I> conventionMapper, PropertyMapper<E, P> propertyMapper, Class<P> poClass) {
    ...
    public List<E> listByIds(Iterable<I> ids) {
        return conventionMapper.listByIds(ids);
    }
    ...
    @Override
    public Page<E> pageByQuery(Query<E> query, PageQuery pageQuery, boolean isCountTotal) {
        return conventionMapper.pageByExample(adaptQuery(query), pageQuery, isCountTotal);
    }
