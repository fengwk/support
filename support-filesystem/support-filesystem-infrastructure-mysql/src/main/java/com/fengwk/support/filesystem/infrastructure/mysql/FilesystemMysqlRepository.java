...
import com.fengwk.support.spring.boot.starter.mysql.convention.ExtensionConventionRepository;

/**
 * 
 * @author fengwk
 */
public abstract class FilesystemMysqlRepository<E extends FilesystemEntity, P extends FilesystemPO> extends ExtensionConventionRepository<E, P, Long> {
